...
const Hero = () => {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20 w-screen">
      ...
      <div className="absolute top-16 md:top-20 left-0 right-0 z-20 text-center px-4">
        <div className="bg-black/50 px-3 py-2 rounded-lg mx-auto inline-block max-w-[90vw] md:max-w-[80vw]">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center mt-32 md:mt-48 w-screen overflow-hidden">
        <div className="max-w-3xl mx-auto w-full">
          {/* Subheading - Better mobile text sizing */}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-yellow-400 font-normal mb-4 md:mb-6 drop-shadow-md leading-tight">
          ...
          {/* Description */}
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white font-medium mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in drop-shadow-md">
